...
describe('findAllFiltered', function() {
	test('works: nameLike filter', async function() {
		let companies = await Company.findAllFiltered(false, false, '2');
		expect(companies).toEqual([
			{
				handle       : 'c2',
				name         : 'C2',
	...
	test('works: minEmployees filter', async function() {
		let companies = await Company.findAllFiltered(2, false, false);
		expect(companies).toEqual([
			{
				handle       : 'c2',
				name         : 'C2',
	...
	test('works: maxEmployees filter', async function() {
		let companies = await Company.findAllFiltered(false, 2, false);
		expect(companies).toEqual([
			{
				handle       : 'c1',
				name         : 'C1',
	...
	test('works: all filters', async function() {
		let companies = await Company.findAllFiltered(1, 2, '1');
		expect(companies).toEqual([
			{
				handle       : 'c1',
				name         : 'C1',
